...
ggplot(heights_df, aes(x=height, y=earn, colour = sex)) + geom_point()
...
ggplot(heights_df, aes(x=height, y=earn, colour = sex)) + geom_point() + ggtitle("Height vs. Earnings") + xlab("Height (Inches)") + ylab("Earnings (Dollars)")
