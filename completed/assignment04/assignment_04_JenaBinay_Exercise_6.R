...
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/01-sex-vs-earn-JenaBinay.png")

## race vs. earn
ggplot(heights_df, aes(x=race, y=earn)) + geom_point()+ geom_boxplot()
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/02-race-vs-earn-JenaBinay.png")

# https://ggplot2.tidyverse.org/reference/geom_bar.html
## Using `geom_bar()` plot a bar chart of the number of records for each `sex`
ggplot(heights_df, aes(sex)) + geom_bar()
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/03-sex-bar-chart-JenaBinay.png")

## Using `geom_bar()` plot a bar chart of the number of records for each race
ggplot(heights_df, aes(race)) + geom_bar()
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/04-race-bar-chart-JenaBinay.png")

## Create a horizontal bar chart by adding `coord_flip()` to the previous plot
ggplot(heights_df, aes(race)) + geom_bar()
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/05-horizontal-race-bar-chart-JenaBinay.png")
...
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/06-florida-cases-JenaBinay.png")
...
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/07-all-cases-JenaBinay.png")
...
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/08-all-cases-colors-JenaBinay.png")
...
ggplot(data=florida_df, aes(x=date, group=1)) +
  ...
  xlab(" ") + ylab("Cases")
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/09-all-cases-colors-legend-JenaBinay.png")
...
ggsave("/Users/binayprasannajena/Documents/GitHub/dsc520/completed/assignment04/plots/10-all-cases-log-JenaBinay.png")